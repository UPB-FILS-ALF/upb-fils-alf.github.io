...
Vous pouvez aussi regarder les testes [ici](https://github.com/UPB-FILS-ALF/devoir-3-tests/tree/master).
...
3. Testez votre implantation. Vous pouvez utiliser les données dans [les testes](https://github.com/UPB-FILS-ALF/devoir-3-tests).
